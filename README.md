...
![图 1：医疗美容纠纷案件核心结论概览图](图1-核心结论概览图.png)
...
![图 2：维权成功率分布扇形图](图2-维权成功率扇形图.png)
...
![图 3：诉求金额与判决金额](图3-诉求金额与判决金额.png)
...
![图 4：各省案件数量条形热力图](图4-各省案件数量条形热力图.png)
...
![图 5：各地区案件数量占比分布图](图5-各地区案件数量占比分布图.png)
...
![图 6：不同资质情况下判决结果分布的堆叠柱状图](图6-不同资质判决结果堆叠柱状图.png)
...
![图 7：不同资质情况下判决结果分布的百分比堆叠图](图7-不同资质判决结果百分比堆叠图.png)
...
![图 8：一级服务类型纠纷扇形图](图8-一级服务类型纠纷扇形图.png)
...
![图 9：细分项目纠纷原因热力图](图9-细分项目纠纷原因热力图.png)
...
![图 10：纠纷关键词词云图](图10-纠纷关键词词云图.png)
...
![图 11：关键证据类型胜诉率条形图](图11-关键证据类型胜诉率条形图.png)
...
![图 12：有无鉴定报告支持率对比图](图12-有无鉴定报告支持率对比图.png)
